...
namespace TelegramBotProject1
{
    class Program
    {
        ...
        private static void Bot_OnMessage(object sender, Telegram.Bot.Args.MessageEventArgs e)
        {
            if (!playing)
            {
                if (start)
                {
                    ...
                    else if (e.Message.Text == btn_txt4 || e.Message.Text == "/help")
                    {
                        ShowHelp(e);
                        deleteErrorMsg(e);
                    }
        ...
        static void ShowHelp(Telegram.Bot.Args.MessageEventArgs e)
        {
            ...
            string help_str = "- In this game you will be attempting to guess the number generated by the computer by only getting two types of hints.\n";
            help_str += "- You are provided with a keyboard by the bot you should use it for input.\n\n";
            help_str += "- after you have submitted your guess which can only be <b>not rpeated 4 digits long</b> containing numbers between 0 and 9 you will be given two scores an Id score and a position score in their respective columns.\n\n";
            help_str += "- The ID score telles you if there are any digits in the one you have submitted that exists in the generated one.\n\n";
            help_str += "  eg. if the generated number is 1234\nand your guess is 5624\nyou will get an id score of 2 because 2 and 4 are in the generated number.\n\n";
            help_str += "- the position score tells you of the digits that are in both yours and the generated one which ones you have gotten the position correct on.\n\n";
            help_str += "  eg. if the generated number is 1234\nand your guess is 5624\nyou will ge a position score of one because only 4 is in the same position in both your number and the generated one\n\n";
            help_str += "- you are allowed to start with the number 0.(eg. 0123 is acceptable).\n\n";
            help_str += "- you are supposed to guess using the process of elimination(although the first two tries in most cases are just guesses).\n\n";
            help_str += "- you will win when you get 4 on both scores which means you have guessd the number.\n\n";
            help_str += "- you will win when you get 4 on both scores which means you have guessd the number.\n\n";
            help_str += "<b>P.S For All Cases use the keyboard provided by the bot</b>";
            //about section
